  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta property="og:title" content="AiGo - Промпти" />
        <meta
          property="og:image"
        ...
        <meta
          name="description"
          content="Інноваційні промти для нейромереж: підвищуйте ефективність навчання та креативність AI за допомогою Ai-Go."
        />
